...
# %% auto 0
__all__ = ['path', 'data_folder', 'learn', 'titles', 'get_movie_recs', 'search_movies_n_recommend']
...
#             print(f'Your Favorite Movies:  {full_title}')
    ...
    recommendations = get_movie_recs(full_title=full_title, learn=learn, titles=titles) 
